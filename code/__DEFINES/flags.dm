...
#define PASSALL (PASSTABLE | PASSTRANSPARENT | PASSGRILLE | PASSBLOB | PASSMOB | PASSCLOSEDTURF | LETPASSTHROW | PASSMACHINE | PASSSTRUCTURE | PASSFLAPS | PASSDOORS | PASSANOMALY | LETPASSCLICKS | PASSFOAM)
